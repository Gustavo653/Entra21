...
namespace Gerenciando_SQL_Server_Compact_4
{
    public partial class Form1 : Form
    {
        ...
        private void btnCriarBD_Click(object sender, EventArgs e)
        {
            ...
            string Resultado = Interaction.InputBox(Prompt, Titulo, @"C:\Users\ujipe\Desktop\Gerenciando_SQL_Server_Compact_4\DB.sdf", 650, 350);
        ...
        private void btnCriarTabelas_Click(object sender, EventArgs e)
        {
         ...
         private string stringConexao()
         {
             ...
             try
             {
                 string nomeArquivo = @"C:\Users\ujipe\Desktop\Gerenciando_SQL_Server_Compact_4\DB.sdf";
                 string senha = "";
